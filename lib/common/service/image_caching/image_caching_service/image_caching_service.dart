...
import 'package:quiz_radioamatori/common/service/image_caching/model/image_cached/image_cached.dart';
...
class ImageCachingService {
  ...
  Future<void> cacheImage({
    ...
    await storageClient.write('image_cached_$imageId', jsonEncode(imageCached.toJson()));
  }
