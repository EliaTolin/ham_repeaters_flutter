            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: const Text('Ricevi subito feedback su corretto/errato'),
              ...
              child: Container(
                ...
                child: ListTile(
                  leading: Container(
                    ...
                    child: Icon(Icons.fact_check_rounded, color: theme.colorScheme.tertiary),
                  ),
                  title: Text(
                    'Esame',
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                  ...
                  subtitle: const Text('Modalità esame, senza feedback immediato'),
                  trailing: Icon(Icons.chevron_right_rounded, color: theme.colorScheme.tertiary),
