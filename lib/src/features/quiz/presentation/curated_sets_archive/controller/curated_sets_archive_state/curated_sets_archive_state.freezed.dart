...
mixin _$CuratedSetsArchiveState {
  List<CuratedSetPreview> get items;
...
abstract mixin class $CuratedSetsArchiveStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CuratedSetPreview> items, String? errorMessage});
}
...
extension CuratedSetsArchiveStatePatterns on CuratedSetsArchiveState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<CuratedSetPreview> items, String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _CuratedSetsArchiveState implements CuratedSetsArchiveState {
  const _CuratedSetsArchiveState(
      {final List<CuratedSetPreview> items = const <CuratedSetPreview>[],
      this.errorMessage})
      : _items = items;

  final List<CuratedSetPreview> _items;
  @override
  @JsonKey()
  List<CuratedSetPreview> get items {
