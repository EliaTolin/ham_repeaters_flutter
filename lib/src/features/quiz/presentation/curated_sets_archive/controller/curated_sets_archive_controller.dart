...
class CuratedSetsArchiveController extends _$CuratedSetsArchiveController {
  ...
  Future<CuratedSetsArchiveState> build() async {
    try {
      final publishedSets = await ref.read(getAllPublishedCuratedSetsProvider.future);
      ...
      final nonAttemptedSets = await ref.read(curatedSetNonAttemptedProvider(userId).future);
