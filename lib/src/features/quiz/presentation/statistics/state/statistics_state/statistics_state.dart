...
abstract class StatisticsState with _$StatisticsState {
  ...
  List<TopicAccuracy> get sortedTopicsStrongest =>
      List.from(topicAccuracies)..sort((a, b) => b.accuracyPercent.compareTo(a.accuracyPercent));

  List<TopicAccuracy> get sortedTopicsWeakest =>
      List.from(topicAccuracies)..sort((a, b) => a.accuracyPercent.compareTo(b.accuracyPercent));

  List<TopicAccuracy> get top5StrongTopics => sortedTopicsStrongest.take(5).toList();

  List<TopicAccuracy> get top5WeakTopics => sortedTopicsWeakest.take(5).toList();
}
