          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                dashboardAsync.when(
                  data: (state) => LeaderboardPositionSection(userPosition: state.userPosition),
                ...
                dashboardAsync.when(
                  ...
                  loading: () => Skeletonizer(
                    child: CuratedSetsSection(curatedSets: _createMockCuratedSets()),
                  ),
                  error: (error, stack) => _buildErrorSection(context, error, ref),
                ),
                ...
                dashboardAsync.when(
                  ...
                  loading: () => Skeletonizer(
                    child: RecentQuizzesSection(scores: _createMockQuizScores()),
                  ),
                  error: (error, stack) => _buildErrorSection(context, error, ref),
                ),
