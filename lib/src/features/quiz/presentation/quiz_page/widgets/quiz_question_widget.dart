...
class QuizQuestionWidget extends StatelessWidget {
                    ...
                    child: Column(
                      children: [
                        _buildAnswerOption(
                          ...
                          isCorrectLetter: question.correctLetter.toUpperCase() == 'A',
                        ...
                        _buildAnswerOption(
                          ...
                          isTrainingMode: isTrainingMode,
                          isCorrectLetter: question.correctLetter.toUpperCase() == 'B',
                          isWrongSelection: isTrainingMode &&
                              currentAnswer != null &&
                              currentAnswer == 'B' &&
                        ...
                        _buildAnswerOption(
                          ...
                          isTrainingMode: isTrainingMode,
                          isCorrectLetter: question.correctLetter.toUpperCase() == 'C',
                          isWrongSelection: isTrainingMode &&
                              currentAnswer != null &&
                              currentAnswer == 'C' &&
  ...
  Widget _buildAnswerOption({
    ...
    final shouldHighlightCorrect = isTrainingMode && (isSelected || isWrongSelection);
  ...
  Widget _buildTrainingFeedback(BuildContext context) {
    final isCorrect = (currentAnswer?.toUpperCase() ?? '') == question.correctLetter.toUpperCase();
    final title = isCorrect ? 'Risposta corretta' : 'Risposta errata';
    final color =
        isCorrect ? Theme.of(context).colorScheme.tertiary : Theme.of(context).colorScheme.error;
