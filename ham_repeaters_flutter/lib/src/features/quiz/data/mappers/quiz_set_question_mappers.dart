...
import 'package:ham_repeaters/src/features/quiz/domain/quiz_set_question/quiz_set_question.dart';

class QuizSetQuestionMapper
    implements Mapper<QuizSetQuestion, QuizSetQuestionModel> {
  @override
  ...
  QuizSetQuestion fromModel(QuizSetQuestionModel model) {
    return QuizSetQuestion(
      ...
      answeredAt:
          model.answeredAt != null ? DateTime.parse(model.answeredAt!) : null,
      timeMs: model.timeMs,
    );
  }
}
