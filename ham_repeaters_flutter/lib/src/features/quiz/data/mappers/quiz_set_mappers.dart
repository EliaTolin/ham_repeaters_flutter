...
import 'package:ham_repeaters/src/features/quiz/data/model/quiz_set_model/quiz_set_model.dart';
import 'package:ham_repeaters/src/features/quiz/domain/quiz_set/quiz_set.dart';
...
class QuizSetMapper implements Mapper<QuizSet, QuizSetModel> {
  ...
  QuizSet fromModel(QuizSetModel model) {
    return QuizSet(
      ...
      finishedAt:
          model.finishedAt != null ? DateTime.parse(model.finishedAt!) : null,
    );
  }
}
