...
import 'package:ham_repeaters/src/features/quiz/data/mappers/quiz_set_response_mappers.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/curated_set_model/curated_set_model.dart';
...
import 'package:ham_repeaters/src/features/quiz/data/model/quiz_set_question_result_model/quiz_set_question_result_model.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/quiz_set_response_model/quiz_set_response_model.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/quiz_set_score_model/quiz_set_score_model.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/topic_accuracy_model/topic_accuracy_model.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/topic_model/topic_model.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/topic_with_stats_model/topic_with_stats_model.dart';
import 'package:ham_repeaters/src/features/quiz/data/model/total_accuracy_model/total_accuracy_model.dart';
...
class QuizDataSourceSupabase {
  ...
  Future<QuizSetResponse> getQuizSet({
    ...
    try {
      ...
      if (data['success'] != true) {
        throw Exception(
            'Edge function returned error: ${data['error'] ?? 'Unknown error'}');
      }
  ...
  Future<List<QuizSetScoreModel>> getAllQuizScores() async {
    try {
      ...
      return (response as List)
          .map((json) => QuizSetScoreModel.fromJson(json))
          .toList();
    } catch (e, st) {
      await Sentry.captureException(e, stackTrace: st);
  ...
  Future<List<QuizSetQuestionResultModel>> getQuestionStatistics() async {
    try {
      ...
      return (response as List)
          .map((json) => QuizSetQuestionResultModel.fromJson(json))
          .toList();
    } catch (e, st) {
      await Sentry.captureException(e, stackTrace: st);
  ...
  Future<List<QuizSetQuestionModel>> getAnswers(String setId) async {
    try {
      ...
      return (response as List)
          .map((json) => QuizSetQuestionModel.fromJson(json))
          .toList();
    } catch (e, st) {
      await Sentry.captureException(e, stackTrace: st);
  ...
  Future<List<QuizSetQuestionResultModel>> getQuizAnswersWithResults(
      String setId) async {
    try {
  ...
  Future<List<TopicWithStatsModel>> getTopicsWithStats() async {
    try {
      ...
      return (response as List)
          .map((json) => TopicWithStatsModel.fromJson(json))
          .toList();
    } catch (e, st) {
      await Sentry.captureException(e, stackTrace: st);
  ...
  Future<List<TopicAccuracyModel>> getUserTopicAccuracy(String userId) async {
    try {
      final response = await _supabase
          .rpc('user_topic_accuracy', params: {'p_user_id': userId});
      return (response as List)
          .map((json) => TopicAccuracyModel.fromJson(json))
          .toList();
    } catch (e, st) {
      await Sentry.captureException(e, stackTrace: st);
  ...
  Future<TotalAccuracyModel?> getUserTotalAccuracy(String userId) async {
    try {
      final response = await _supabase.rpc('user_total_accuracy',
  ...
  Future<List<CuratedSetPreviewModel>> getCuratedSetsNonAttemptedByUser(
      String userId) async {
    try {
      final response = await _supabase.rpc('curated_set_non_attempted_by_user',
      ...
      return data
          .map((json) =>
              CuratedSetPreviewModel.fromJson(json as Map<String, dynamic>))
          .toList();
    } catch (e, st) {
      await Sentry.captureException(e, stackTrace: st);
