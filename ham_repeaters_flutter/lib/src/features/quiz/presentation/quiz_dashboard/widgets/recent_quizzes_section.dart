            ...
            child: Row(
              children: [
                ...
                if (scores.isNotEmpty)
                  _pill(theme, '${scores.length}', theme.colorScheme.primary),
              ],
            ),
          ),
...
class _ClickableQuizCard extends StatelessWidget {
  const _ClickableQuizCard(
      {required this.theme, required this.score, this.onTap});
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return ConstrainedBox(
                constraints:
                    const BoxConstraints(minHeight: 64), // touch target
                child: Row(
                  children: [
                    ...
                    ConstrainedBox(
                      constraints:
                          BoxConstraints(maxWidth: trailingMaxW.toDouble()),
                      child: Column(
...
class _ProgressRing extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bg =
        Theme.of(context).colorScheme.outlineVariant.withValues(alpha: .35);
