...
import 'package:ham_repeaters/src/features/quiz/provider/delete_all_quiz_set/delete_all_quiz_set_provider.dart';
...
class StatisticsController extends _$StatisticsController {
  ...
  Future<StatisticsState> build() async {
    ...
    final topicAccuracies =
        await ref.read(getUserTopicAccuracyProvider(userId).future);
    final recentScores =
        await ref.read(recentQuizScoresProvider(limit: 10).future);
