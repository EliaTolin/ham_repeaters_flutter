...
import 'package:ham_repeaters/src/features/quiz/presentation/marathon_quiz/controller/marathon_controller.dart';
...
class MarathonQuizPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: state.when(
        data: (data) => data.canStartMarathon
            ? _buildFloatingActionButton(context, ref, data)
            : null,
        loading: () => null,
        error: (_, __) => null,
      ),
  ...
  Widget _buildFloatingActionButton(
    ...
    return GestureDetector(
      onTap: () =>
          state.isStarting ? null : _startMarathon(context, ref, state),
      child: Container(
  ...
  Widget _buildTopicCard(
    ...
    return Card(
      ...
      shadowColor:
          isSelected ? Theme.of(context).colorScheme.primary : Colors.black26,
