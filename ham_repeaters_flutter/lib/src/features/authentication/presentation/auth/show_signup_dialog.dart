...
import 'package:ham_repeaters/common/utils/deep_link_utils.dart';
...
import 'package:ham_repeaters/src/features/authentication/presentation/auth/widgets/sign_in_buttons.dart';
...
Future<void> showSignUpDialog(
  ...
  await showDialog(
    ...
    builder: (BuildContext dialogContext) {
      return Consumer(
        builder:
            (BuildContext dialogBuildContext, WidgetRef ref, Widget? child) {
          return Dialog(
                          ...
                          child: Padding(
                            ...
                            child: SupaEmailAuth(
                              ...
                              localization: SupaEmailAuthLocalization(
                                ...
                                enterPassword:
                                    'Inserisci la password'.hardcoded,
                                forgotPassword:
                                    'Password dimenticata?'.hardcoded,
                                ...
                                passwordLengthError:
                                    'La password deve essere più lunga'
                                        .hardcoded,
                                dontHaveAccount:
                                    'Non hai un account? Registrati'.hardcoded,
                                haveAccount:
                                    'Hai già un account? Accedi'.hardcoded,
                                backToSignIn: "Torna all'accesso".hardcoded,
                                unexpectedError: 'Errore inaspettato'.hardcoded,
                                validEmailError:
                                    "Inserisci un'email valida".hardcoded,
                                sendPasswordReset:
                                    'Invia reset password'.hardcoded,
                                passwordResetSent:
                                    'Reset password inviato'.hardcoded,
                              ),
                              redirectTo:
                                  DeepLinkUtils.buildDeepLink('login-callback'),
                              resetPasswordRedirectTo:
                                  DeepLinkUtils.buildDeepLink(
                                'change-password',
                              ),
