...
@RoutePage()
class RepeatersListPage extends ConsumerWidget {
...
class _RepeaterListItem extends StatelessWidget {
  const _RepeaterListItem({
    ...
    required this.getModeLabel,
    required this.formatFrequency,
  });

  final Repeater repeater;
  final String Function(RepeaterMode, AppLocalizations) getModeLabel;
  final String Function(int) formatFrequency;
            ...
            children: [
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      getModeLabel(repeater.mode, l10n),
              ...
              Row(
                children: [
                  ...
                  Text(
                    formatFrequency(repeater.frequencyHz),
      ...
      child: Column(
        ...
        children: [
          ...
          _DetailRow(
            ...
            value: getModeLabel(repeater.mode, l10n),
