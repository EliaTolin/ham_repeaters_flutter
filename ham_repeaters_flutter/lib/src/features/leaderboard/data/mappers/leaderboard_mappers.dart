...
class LeaderboardMappers
    implements Mapper<LeaderboardEntry, LeaderboardEntryModel> {
  @override
  LeaderboardEntry fromModel(LeaderboardEntryModel model) {
    return LeaderboardEntry(
      ...
      lastAnsweredAt: model.lastAnsweredAt != null
          ? DateTime.parse(model.lastAnsweredAt!)
          : null,
      rank: model.rank,
    );
  }
